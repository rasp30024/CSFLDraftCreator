...
{
    public class AuditReporCSVModel
    {
        //Audit Information
        public string InputFirstName { get; set; } = string.Empty;
        public string InputLastName { get; set; } = string.Empty;
        public string InputCollege { get; set; } = string.Empty;
        public string InputPosition { get; set; } = string.Empty;
        public int InputAge { get; set; } = 0;
        public string InputHeight { get; set; } = string.Empty;
        public int InputWeight { get; set; } = 0;
        public string InputTier { get; set; } = string.Empty;
        public string InputTrait { get; set; } = string.Empty;
        public string InputStyle { get; set; } = string.Empty;
        //Added by Sim
        public string AddedTrait { get; set; } = string.Empty;
        public string AddedStyle { get; set; } = string.Empty;

        //Upcoming Draft Model
